...
| Lab | Topic | Status |
|-----|-------|--------|
| [`01-cuda-vector-add/`](./01-cuda-vector-add/) | First CUDA kernel — vector addition | Complete |
| [`02-cuda-tiled-matmul/`](./02-cuda-tiled-matmul/) | Tiled matrix multiplication with shared memory | Complete |
| [`03-nsight-profiling/`](./03-nsight-profiling/) | GPU profiling with Nsight Systems / Compute | Planned |
| [`04-fused-gemm-bias-relu/`](./04-fused-gemm-bias-relu/) | Fused GEMM + Bias + ReLU kernel | Planned |
| [`05-memory-bandwidth-roofline/`](./05-memory-bandwidth-roofline/) | Memory bandwidth analysis + roofline model | Planned |
| [`06-warp-reductions/`](./06-warp-reductions/) | Warp-level primitives and parallel reductions | Planned |
